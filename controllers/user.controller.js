...
// after uploading the all details .....then after we will save all the things inside the mongodb ......
  await user.save();
...
res.cookie('token',token,cookieOptions);
   ...
   // status code 201 means :-  The request has been successfully fulfilled, and a new resource has been created as a result. The URI (Uniform Resource Identifier) of the newly created resource is typically provided in the response's Location header.
   res.status(201).json({
    success: true,
    message: 'User registered successfully and logedIn..',
    user,
  });
